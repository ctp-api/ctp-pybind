...
from script.generate_helper import underscore_to_camelcase, camel_to_underscore_upper
...
class GeneratorFunctionConst:
    def __init__(self, filename: str, prefix: str, name: str, class_name: str, output_dir: str) -> None:
        ...
        self.output_dir: str = output_dir  # "../ctp/api/generator/"
    ...
    def generate_base_functon_names(self):
        ...
        funcs_filename = f"{self.output_dir}{func_filename_prefix}.py"
...
if __name__ == "__main__":
    ...
    td_const_generator = GeneratorFunctionConst(
